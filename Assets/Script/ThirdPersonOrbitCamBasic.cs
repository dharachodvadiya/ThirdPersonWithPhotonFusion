...
public class ThirdPersonOrbitCamBasic : MonoBehaviour
{
	...
	public InputReader inputReader;										// player input
    ...
    void LateUpdate()
	{
		...
		angleV += inputReader.MouseDelta.y;
	...
	public void SetFOV(float customFOV)
	{
		...
		this.targetFOV = Mathf.Clamp(this.targetFOV, 30, 120);

		float minF = 60, maxF = 120, minA = 35, maxA = 30;

		maxVerticalAngle = minA + (((maxA - minA) / (maxF - minF)) * (this.targetFOV - minF));
		SetMaxVerticalAngle(maxVerticalAngle);
	}
